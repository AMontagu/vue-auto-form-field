    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                unknownErrorMessage: this.$vaffT('vaffField.vaffMediaField.vaffMediaUpload.UnknownError'),
        ...
        created() {
            if (this.label === 'Click here or drop a file') {
                this.shownLabel = this.$vaffT('vaffField.vaffMediaField.vaffMediaUpload.ClickOrDrop');
            } else {
        ...
        methods: {
            ...
            addFile(file) {
                if (!/[!@#$%^&*(),?":{}|<>\s/]/.test(file.name)) {
                    ...
                    this.uploadError = this.$vaffT('vaffField.vaffMediaField.vaffMediaUpload.ErrorImgName');
                    this.showModalError = true;
                }
            },
